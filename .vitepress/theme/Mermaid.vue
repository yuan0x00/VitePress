<template>
  <div v-if="props.showCode">
    ...
    <div class="language-mermaid">
      ...
      <pre><code ref="editableContent" :contenteditable="contentEditable" class="editable-code"
                 @input="updateCode" @keydown.meta.enter="renderChart" @keydown.ctrl.enter="renderChart"></code></pre>
